...
# note: all data needs to be saved in wd ("allstations_raw.rds", "ECCC_Climate_Data_Merged.rds","sites.csv", OPTIONAL: scotty_clean_daily.rds", "scotty_raw_daily.rds", "FTS_othersites_clean_daily.rds", "FTS_othersites_raw_daly.rds", )
